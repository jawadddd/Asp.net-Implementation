<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="logIn.aspx.cs" Inherits="signupSignin.logIn" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ESHOP_Login</title>
        <style>
        body{
...
<body>
    <form id="form1" runat="server">
            ...
            <asp:Label ID="Label3" runat="server" Text="Log-In"></asp:Label><br/>
